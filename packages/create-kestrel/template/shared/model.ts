...
export const locales = __LOCALES__ as const;
export const defaultLocale = __DEFAULT_LOCALE__;

export const prefixPrimary = false;

export type UntranslatedPagesPolicy = "notFound" | "redirect";

export const untranslatedPages: UntranslatedPagesPolicy = "notFound";
...
export const features = __FEATURES__ as const satisfies readonly Feature[];
