...
export default defineConfig({
  test: {
    projects: [
      ...
      {
        resolve: { alias: [{ find: "#kestrel/cast", replacement: castEntry }, { find: "#kestrel/optional-modules", replacement: optionalModulesNone }, { find: /^#kestrel-core\//, replacement: `${coreLayerDir}/` }] },
        test: {
          name: "rest",
